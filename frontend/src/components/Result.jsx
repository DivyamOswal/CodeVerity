...
export default function Result({
  ...
  const doGenerateTests =
    generateTestsFn ?? defaultGenerateTests;
        ...
        <div className="flex flex-col gap-4 border-b border-[#21262d] pb-5 md:flex-row md:items-center md:justify-between">
          ...
          <div>
            <div className="mb-2 flex items-center gap-2">
              ...
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#2563eb] to-[#7c3aed] text-sm shadow-lg shadow-blue-500/10">
                <span>⌘</span>
              </div>

              <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#58a6ff]">
                CodeVerity
              </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="rounded-xl border border-[#30363d] bg-[#161b22] px-4 py-2.5">
              ...
              <div className="mt-0.5 text-2xl font-bold text-[#58a6ff]">
                {grade}
              </div>
            ...
            {onDownload && (
              <button
                onClick={onDownload}
                className="flex items-center gap-2 rounded-lg border border-[#30363d] bg-[#161b22] px-4 py-2.5 text-xs font-semibold text-[#c9d1d9] transition-all hover:border-[#58a6ff]/40 hover:bg-[#21262d] hover:text-[#58a6ff]"
              >
                <span>↓</span>
                Download Report
              </button>
          ...
          <div className="flex items-center gap-1">
            ...
            {[
              ...
              >
                ...
                {activeTab === tab.id && (
                  <span className="absolute bottom-0 left-2 right-2 h-[2px] rounded-full bg-[#58a6ff]" />
                )}
                  ...
                  {architecture.map((a, i) => (
                    ...
                    >
                      ...
                      <div className="mb-1 flex items-center gap-2">
                        ...
                        <span className="flex h-5 w-5 items-center justify-center rounded bg-[#1f6feb]/10 text-[10px] text-[#58a6ff]">
                          {i + 1}
                        </span>
                ...
                <div className="space-y-2">
                  ...
                  {futureRoadmap.map((f, i) => (
                    ...
                    >
                      ...
                      <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#8957e5]/10 text-[10px] text-[#a371f7]">
                        {i + 1}
                      </div>
              ...
              {toolsAndPackages.length ? (
                <div className="flex flex-wrap gap-2">
                  ...
                  {toolsAndPackages.map((t, i) => (
                    <span
                      key={i}
                      className="rounded-md border border-[#30363d] bg-[#161b22] px-2.5 py-1 text-[10px] font-mono text-[#8b949e] transition hover:border-[#58a6ff]/40 hover:text-[#58a6ff]"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <>
                        ...
                        (file, i) => (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between border-b border-[#21262d] bg-[#161b22] px-3 py-2">
                              ...
                              <span className="max-w-[60%] truncate text-[11px] font-mono text-[#58a6ff]">
                                {file.fileName}
                              </span>
                ...
                {testData.unitTests?.length > 0 && (
                  ...
                  >
                    ...
                    <div className="space-y-5">
                      ...
                      {testData.unitTests.map(
                        (fn, i) => (
                          <div key={i}>

                            <div className="mb-1 flex flex-wrap items-center gap-2">

                              <span className="font-mono text-xs font-semibold text-[#a371f7]">
                                {fn.functionName}()
                              </span>
                ...
                <div className="flex justify-end">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-lg border border-[#30363d] bg-[#161b22] px-3 py-2 text-[11px] font-medium text-[#8b949e] transition hover:border-[#58a6ff]/40 hover:bg-[#21262d] hover:text-[#58a6ff] disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    <span>↻</span>
                    Re-generate Tests
                  </button>
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#30363d] bg-[#161b22] shadow-[0_4px_20px_rgba(0,0,0,0.12)]">
      ...
      <div className="flex items-center gap-2 border-b border-[#21262d] px-4 py-3">
        ...
        <span className="flex h-6 w-6 items-center justify-center rounded-md bg-[#1f6feb]/10 text-[11px] text-[#58a6ff]">
          {icon}
        </span>
...
function ScoreCard({
  ...
  const colorMap = {
    blue: {
      icon: "bg-[#1f6feb]/10 text-[#58a6ff]",
      bar: "bg-[#58a6ff]",
      number: "text-[#58a6ff]",
    },

    purple: {
      icon: "bg-[#8957e5]/10 text-[#a371f7]",
      bar: "bg-[#a371f7]",
      number: "text-[#a371f7]",
    },

    cyan: {
      icon: "bg-[#0891b2]/10 text-[#22d3ee]",
      bar: "bg-[#22d3ee]",
      number: "text-[#22d3ee]",
    },
    ...
    <div className="rounded-xl border border-[#30363d] bg-[#161b22] p-3.5 transition-all hover:border-[#484f58]">
      ...
      <div className="mt-3 flex items-end justify-between">
        ...
        <div>
          ...
          <p
            className={`mt-0.5 text-xl font-bold ${colors.number}`}
          >
            {val || "N/A"}
          </p>
        ...
        <span className="mb-1 text-[10px] text-[#484f58]">
          /100
        </span>
...
function Badge({
  ...
  const colors = {
    blue:
      "border-[#1f6feb]/20 bg-[#1f6feb]/10 text-[#58a6ff]",

    green:
      "border-[#238636]/20 bg-[#238636]/10 text-[#3fb950]",

    purple:
      "border-[#8957e5]/20 bg-[#8957e5]/10 text-[#a371f7]",

    cyan:
      "border-[#0891b2]/20 bg-[#0891b2]/10 text-[#22d3ee]",

    yellow:
      "border-[#d29922]/20 bg-[#d29922]/10 text-[#d29922]",
  };
